...
(defun simple-paren-runs-this-script-p ()
  t)

(defun simple-paren-run-tests-main ()
  ...
  (let* ((load-prefer-newer t)
    ...
    (let ((debug-on-error t)
          (tests (list
		  "simple-paren-emacs-lisp-tests.el"
		  )))
      (load (expand-file-name "simple-paren" source-directory))

      (load (expand-file-name "simple-paren-setup-ert-tests" current-dir))
    ...
    (let ((debug-on-error t)
      ...
      (ert-run-tests-batch-and-exit (and "simple-paren-" ert-selector)))))
